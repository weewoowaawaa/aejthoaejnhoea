...
local win = Flux:Window("PLS DONATE", "Cracked by heqds#2146", Color3.fromRGB(0, 128, 0), Enum.KeyCode.RightShift)
...
otherTab:Button("Discord Server", "Copies Discord server link", function()
	...
	Flux:Notification("Copied to clipboard", "https://discord.gg/MqsgXZBgqE", "Okay")
end)
